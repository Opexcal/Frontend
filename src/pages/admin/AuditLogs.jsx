...
const AuditLogs = () => {
  ...
  const fetchLogs = async () => {
    try {
      ...
      // Your backend uses sendSuccess which wraps data in { success, data, message }
      const responseData = response.data?.data || response.data || response;
      
      console.log("API Response:", response); // Debug log
      console.log("Extracted Data:", responseData); // Debug log
  ...
  const fetchStats = async () => {
    try {
      ...
      console.log("Extracted Stats:", responseData); // Debug log
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              {stats.topActors[0] ? (
                <>
                  <div className="text-2xl font-bold">{stats.topActors[0].actionCount}</div>
                  <p className="text-xs text-muted-foreground">{stats.topActors[0].user?.name}</p>
                </>
              ) : (
