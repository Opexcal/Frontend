    ...
    <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold mt-1">
                  {mockData.stats.personalTasks.completed}/{mockData.stats.personalTasks.total}
                </p>
                <p className="text-xs text-muted-foreground mt-1">
                  {mockData.stats.personalTasks.percentage}% complete
                </p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold mt-1">{mockData.stats.assignedTasks.total}</p>
                <p className="text-xs text-muted-foreground mt-1">
                  {mockData.stats.assignedTasks.pending} pending response
                </p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold mt-1">{mockData.stats.personalEvents.thisWeek}</p>
                <p className="text-xs text-muted-foreground mt-1">
                  Next: {mockData.stats.personalEvents.nextEvent}
                </p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            {mockData.personalTasks.length === 0 ? (
              ...
              <div className="space-y-3">
                {mockData.personalTasks.slice(0, 5).map((task) => (
                  <div
                    key={task.id}
        ...
        <Card>
          ...
          <CardContent>
            {mockData.assignedTasks.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
              ...
              <div className="space-y-3">
                {mockData.assignedTasks.map((task) => (
                  <div
                    key={task.id}
